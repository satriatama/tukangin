...
public class ProfileFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        View btnAddressSetup;
        btnAddressSetup = view.findViewById(R.id.btnAddressSetup);
        btnAddressSetup.setOnClickListener(v -> {
            Intent intent = new Intent(getActivity(), AddressSetupActivity.class);
            startActivity(intent);
        });
